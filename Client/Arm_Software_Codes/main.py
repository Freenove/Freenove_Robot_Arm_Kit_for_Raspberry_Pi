...
class myClientWindow(QMainWindow, Ui_Arm):
    ...
    def __init__(self, parent=None):
        ...
        ip_validator = QRegExpValidator(QRegExp(r'^((2[0-4]\d|25[0-5]|\d?\d|1\d{2})\.){3}(2[0-4]\d|25[0-5]|[01]?\d\d?)$'))  
        self.lineEdit_Arm_IP_Address.setValidator(ip_validator)  
        servo_validator = QRegExpValidator(QRegExp(r'^(?:[1-9][0-9]?|1[0-7][0-9]?|180)$'))
